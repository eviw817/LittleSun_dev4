...
include_once(__DIR__ . DIRECTORY_SEPARATOR . "ParentUser.php");
    ...
    class Manager extends ParentUser
    {
        public function newManager()
        {
            ...
            $statement = $conn->prepare("INSERT INTO users (username, email, password, role, firstName, lastName, image) VALUES (:username, :email, :password, :role, :firstName, :lastName, :image);"); //locatie nog toevoegen
